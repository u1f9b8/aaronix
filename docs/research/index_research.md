...
- [MINIX source listing initial map](minix-source-listing-initial-map.md) - first source-study note for Phase 1 sequencing.
...
| --- | --- | --- |
| MINIX source map | Phase 1 epics need source-study anchors for boot, kernel, process, memory, IPC, filesystem, and userspace. | [Initial source listing map](minix-source-listing-initial-map.md) |
